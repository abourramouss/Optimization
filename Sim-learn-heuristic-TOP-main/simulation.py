...
def getDynamicValue(edge, weather, traffic):
    ...
    b_w = 0.2 * edge.cost # coefficient for weather conditions (less influencial factor)
    b_t = 0.3 * edge.cost # coefficient for traffic conditions (more influencial factor)
